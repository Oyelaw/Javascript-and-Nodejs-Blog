 ...
 */
 ...
 helpers.interpolate = function (str, data) {
   ...
   // Add the template globals to the data object, prepending their keyname with golbal
   ...
   // For each key in the data object, we want to insert it's value into the string at the corresponding placeholder
   for (var key in data) {
